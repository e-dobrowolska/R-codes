...
knitr::opts_knit$set(root.dir = 'C:/Users/ewado/OneDrive/Dokumenty/Studia/R-mat/AViR')
```

Source of the dataset: [link](https://www.kaggle.com/datasets/bahramjannesarr/nobel-prize-from-1901-till-2020)  
The dataset contains information regarding nobel prize laureates from 1901 to 2020.
...
## **Barplot**: Month of birth and disciplines  
#### What is the month of birth of the Nobel Prize laureates? Does it vary among types of disciplines? What about Polish scientists?  
...
## **Ranking chart**: top universities   
#### Which universities employ the most laureates of the Nobel Prize? How has the ranking changed over the years? 
...
## **Scatterplot**: Year - age, when received the prize  
#### Age of the nobel prize laureates (when awarded the prize) over the years. Divided by category and gender
...
## **Barplots**: Category and prize share  
#### In what disciplines do laureated win individually, and in which they have to share the prize? Do laureates change the country they live in? Does it depend on the discipline?
...
## **Pie plot**: economic sciences laureates among countries
...
## **Treemap**: economics & American universities  
#### Which of the american universities have had the most winners of the Nobel Prize? What is the mean age of the winners?
...
## **Barplot**: polish winners  
#### In different categories & splitted by gender
...
## **Scatterplot with images**: polish physicists
...
## **Interactive map**: number of winners among countries
...
## **Parallel plot** - category, gender and country change  
...
## **Line plot**: age of the winners in the economic sciences category 
...
## **Interactive plot**: age of the winners in the economic sciences category & country changes
